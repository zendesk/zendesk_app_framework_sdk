var PROMISE_TIMEOUT = 5000, // 5 seconds
    ...
    Promise         = window.Promise || require('../vendor/es6-promise').Promise,
    pendingPromises = {},
    promiseCount    = 0,
    requestCount    = 0;
...
function wrappedPostMessage(name) {
  ...
  deferred.promise.then(removePromise.bind(null, id, timeoutId), removePromise.bind(null, id, timeoutId));
...
function removePromise(id, timeoutId) {
