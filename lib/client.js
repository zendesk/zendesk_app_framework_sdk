...
Client.prototype = {
  ...
  instance: function(instanceGuid) {
    ...
    if (this._instanceClients[instanceGuid]) {
      return Promise.resolve(this._instanceClients[instanceGuid]);
    } else {
      var instanceContextKey = 'instances.' + instanceGuid;
      return this.get(instanceContextKey).then(function(data) {
        var client = new Client({
          parent: this,
          instanceGuid: instanceGuid,
          context: data[instanceContextKey]
        });
        this._instanceClients[instanceGuid] = client;
        return client;
      }.bind(this));
    }
  },
