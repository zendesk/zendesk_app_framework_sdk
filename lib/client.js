...
function processSingleRequest(path, result) {
...
Client.prototype = {
  ...
  get: function(path) {
    ...
    return wrappedPostMessage.call(this, 'get', paths).then(processSingleRequest.bind(null, path));
  },
  ...
  set: function(key, val) {
    ...
    return wrappedPostMessage.call(this, 'set', obj).then(processSingleRequest.bind(null, key));
  },
  ...
  invoke: function(key) {
    ...
    return wrappedPostMessage.call(this, 'invoke', obj).then(processSingleRequest.bind(null, key));
  }
};
