...
Client.prototype = {
  ...
  get: function(path) {
    ...
    if (paths.some(function(s) {return typeof s !== 'string'; })) {
      return Promise.reject('The get method accepts a string or array of strings.');
    }
  ...
  set: function(key, val) {
    ...
    if (typeof key === 'string') {
      if (arguments.length === 1) {
        return Promise.reject('The setter requires a value');
      }
      obj = {};
      obj[key] = val;
    }
    ...
    if (typeof obj === 'object' && !Array.isArray(obj)) {
      Promise.reject('The set method accepts 2 string, or an object.');
    }
